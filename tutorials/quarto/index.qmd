...
description: | 
  Introdução ao Quarto para produzir documentos técnicos e científicos com
  texto, código e resultados integrados.
lang: "pt-BR"
date: "2024-10-07"
toc: true
...
:::columns
:::{.column style="width: 50%; max-height: 1000px"}
```yaml
---
...
:::{.column style="width: 50%; font-size: .85em"}
