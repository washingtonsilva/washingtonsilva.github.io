...
lang: pt
date: "2025-09-24"
title: "Máxima Verossimilhança na Distribuição Uniforme: um exemplo com máximo não diferenciável"
...
Este é um exemplo apresentado por @hansen2022ps. Ele é relevante 
...
@hansen2022ps argumenta que uma característica "interessante e diferente" (traduzo como 
chata e confusa) dessa função de log-verossimilhança é que ela não é diferenciável no máximo. P
ortanto, o estimador de MV não satisfaz a condição de primeira ordem e, por implicação, o 
estimador de MV não pode ser encontrado resolvendo condições de primeira ordem.
